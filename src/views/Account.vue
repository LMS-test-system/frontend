<template>
  <button
    @click="back"
    class="flex items-center bg-blue-300 px-2 py-1 rounded-md my-2"
  >
    <i class="bx bx-left-arrow-alt text-[22px]"></i>Back
  </button>
  <div class="flex gap-10">
    <div v-if="user" class="flex flex-col gap-2">
      ...
      <div class="flex items-center justify-around">
        ...
        ><button
          @click="toggleModal2"
          class="bg-gray-400 px-2 rounded-md text-green-200 focus:ring-1 focus:ring-blue-700 w-[50px] pt-1"
        >
          <i class="bx bx-cloud-upload text-[24px]"></i>
        </button>
      </div>
    </div>
    <div class="flex flex-col items-start gap-2">
      ...
      <p>
        Email:
        <span class="bg-gray-200 px-2 py-1 rounded-md">{{ user.email }}</span>
      </p>
      <p>
        Phone:
        <span class="bg-gray-200 px-2 py-1 rounded-md">{{ user.phone }}</span>
      </p>
      <p>
        Telegram:
        <span class="bg-gray-200 px-2 py-1 rounded-md">{{
      ...
      <button
        @click="updateInfo"
        class="bg-blue-500 px-2 py-1 rounded-md text-white focus:ring-1 focus:ring-blue-700 w-[160px]"
      >
        update info
      </button>
    </div>
