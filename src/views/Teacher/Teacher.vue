<template>
    <div class="p-3">
        <div class="flex justify-between items-center">
            <h2 class="uppercase dark:text-white text-gray-900 text-xl font-bold">O'qituvchilar</h2>
                    ...
                    <table class="w-full text-sm table-auto">
                        ...
                        <tbody class="">
                            <tr class="border-b dark:border-gray-700">
                                ...
                                <td class="px-4 py-3"><p class="bg-blue-300 text-teal-900 py-1 text-center rounded-full font-semibold">Fan o'qituvchisi</p></td>
                                ...
                                <td class="px-4 py-3 text-[20px]">
                                    <div  class="bg-white flex justify-center items-center gap-4">
                                        ...
                                        <a href="/about_teacher" class="px-4 py-1 text-white hover:bg-green-700 text-sm rounded-md bg-green-500"><p>kirish</p></a>
  ...
  <script setup>
    ...
    const addContact=(evet)=>{
        ...
        useTeacher.create(contact).then((res)=>{
            if(res.login == 201){
                contactInfo.full_name = ''
                contactInfo.phone_number = ''
                contactInfo.login = ''
    ...
    const modifyContact=(event)=>{
        ...
        useTeacher.update(id, contact).then((res)=>{
            if(res.login == 200){
                contactInfo.full_name=''
                contactInfo.phone_number=''
                contactInfo.login=''
